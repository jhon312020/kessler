...
Route::get('/controlsessions',[TraineeSessionController::class, 'controlSession']);
Route::post('/controlsessions', [TraineeSessionController::class,'controlStore']);
Route::post('/controlnext', [AjaxController::class,'controlStore']);

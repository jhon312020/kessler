...
<section id="jsTraineeSession">
  ...
  <div class="row">
    <div class="col-lg-8 mx-auto text-justify">
       <p>On the same page below you are going to see a story. It will stay on the screen for a set period of time.</p><p>Certain words in the story will be capitalized like <span class="emboss">THIS</span>.</p><p> Use this story to help you remember the capitalized words. Try to make a picture of each storyline in your head.</p> <p> Click on <span class="emboss">START</span> when you are ready.</p><br/>
    </div>
  </div>
  <div class="row">
    <div class="col-lg-12">
      ...
      <div class="control-group">
        ...
        <div class="row d-none" id="jsCue">
          <div class="col-lg-8 mx-auto">
            <p class="text-center">Click on <span class="emboss">CONTINUE</span> <br/>to proceed with recall words</p>
            <br/>
          </div>
        </div>

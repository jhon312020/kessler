...
<section>
  <div class="row">
    <div class="col-lg-8 mx-auto">
      <h1 class="heading">RECALL STORY</h1>
    </div>
  </div>
  <div class="row">
    <div class="col-lg-8 col-lg-offset-2 mx-auto text-justify">
       <p class="mx-auto">Please input everything you can remember about the story you just read.</p>
    </div>
  </div>
      ...
      <form action="{{ $submitURL }}" method="POST" id="recallWords">
        ...
        <div class="control-group">
          <div class="form-group floating-label-form-group controls mb-0 pb-2">
              <textarea class="form-control" id="jsRecallWord" name="words" type="text" placeholder="Recall Story" autocomplete="off" rows="15"></textarea>
          </div>
          <br/>
        </div>
      </form>

          ...
          <div class="card-body">
            ...
            <form method="post" action="{{ route('shopping.update', $shopping->id) }}">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control py-4" name="item" id="item" placeholder="Enter Item" value="{{$shopping->item}}">
              </div>
              <div class="form-group">
              ...
              <div class="form-group d-flex align-items-center float-right mt-4 mb-0">
                ...
                <a href="{{ url('/shopping')}}" class="ml-2 btn btn-danger" role="button">Cancel</a>
              </div>
            </form>
          </div>
      </div>
